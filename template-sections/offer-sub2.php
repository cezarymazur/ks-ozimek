...
<div class="container">
    <div class="row">
        <div class="col text-white pt-0">
            <div class="full-width-image pos-2 py-5 ps-5 ms-n4" style="background-image: url('<?php the_field('bg_photo'); ?>');">
                <div class="section-heading big-heading ms-n4">
                    <?php the_field('heading'); ?>
                </div>
                <p class="col-12 col-lg-4 my-4 pb-5">
                    <?php the_field('text'); ?>
                </p>
                <a href="<?php the_field('button_url_1'); ?>"><button class="custom-btn text-white"><?php the_field('button_1'); ?></button></a>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col">
        <p class="my-4"><?php the_field('text_2'); ?></p>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col">
        <p class="my-4"><?php the_field('text_3'); ?></p>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row d-flex flex-md-wrap">
        <div class="col-md d-flex m-1 text-white text-center p-5 photo-item-box" style="background-image: url('<?php the_field('real_photo_7'); ?>'); ">
            <div class="col align-self-center photo-item-desc"><?php the_field('real_desc_7'); ?></div>
        </div>

        <div class="col-md d-flex m-1 text-white text-center p-5 photo-item-box" style="background-image: url('<?php the_field('real_photo_8'); ?>'); ">
            <div class="col align-self-center photo-item-desc"><?php the_field('real_desc_8'); ?></div>
        </div>

        <div class="col-md d-flex m-1 text-white text-center p-5 photo-item-box" style="background-image: url('<?php the_field('real_photo_9'); ?>'); ">
            <div class="col align-self-center photo-item-desc"><?php the_field('real_desc_9'); ?></div>
        </div>
    </div>
</div>
