...
<header id="masthead" class="site-header header-front">

<nav class="navbar navbar-expand-lg bg-transparent fixed-top">
  <div class="container">
    <div class="col-lg-2 my-3 mt-lg-5"><img src="http://localhost:8888/ks-ozimek/wp-content/uploads/2021/08/Logo-white.png" /></div>
    <div class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent5" aria-expanded="false" aria-label="Toggle navigation">
    	<i class="bi bi-list" style="background-color:transparent;"></i>
</div>
